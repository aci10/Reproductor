...
public final class ACF_Yin_t implements Detector_F0_i {
    /**
     ...
     */
    private final Result_Detec_F0_t result;
     ...
     */
    public ACF_Yin_t(final float audioSampleRate, final int bufferSize) {
     ...
     */
    public ACF_Yin_t(final float audioSampleRate, final int bufferSize, final double yinThreshold) {
     ...
     */
    public Result_Detec_F0_t getPitch(final float[] audioBuffer) {
